...
[
  ...
  AS_IF([test "$GXX" = "yes" && test "x$ACSM_REAL_GXX" != "x"],
        [
          ...
          # The former is the default but the latter can be necessary
          ...
          AS_IF([test "x$ACSM_GXX_VERSION" != "xgcc11" &&
                 ...
                 test "x$ACSM_GXX_VERSION" != "xgcc7" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc5" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc5" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc4.9" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc4.8" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc4.7" &&
                 test "x$ACSM_GXX_VERSION" != "xgcc4.6"],
                [
                  ACSM_IEEE754_FLAGS="$ACSM_IEEE754_FLAGS -fexcess-precision=standard"
                ])
